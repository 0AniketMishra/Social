...
const Header = () => {
  ...
  {route.name != "Profile" &&(
                <Image style={{ width: 120, resizeMode: 'contain',height: 50, marginLeft: 6}} source={{ uri: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Instagram_logo.svg/1200px-Instagram_logo.svg.png' }} /> 
  )}
                      {route.name === "Profile" && (
